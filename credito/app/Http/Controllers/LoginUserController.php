...
//            );
            return route('ingreso_usuario', ['resultado' => 'Felicitaciones! Tienes un credito aprobado'/*,'sms_success'=>1*/]);
        } else {
            //return route('registro_usuario');
            return route('ingreso_usuario', ['resultado' => 'No cuentas con un crédito aprobado esta oportunidad'/*,'sms_success'=>1*/]);
        }
    }
}
